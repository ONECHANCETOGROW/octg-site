...
<?php elseif ($tab === 'links'): ?>
  ...
  <?php if (!$linkStats['available']): ?>
    <div class="admin-panel" style="border-color:#8a6d1a;"><div class="admin-panel__body"><?php echo htmlspecialchars($linkStats['reason']); ?> <a href="/admin8828051506/cron/run-audit.php?manual=1">Run an audit</a>.</div></div>
  <?php else: ?>
    <div class="admin-grid">
