...
/* ==========================================================================
   ...
   TO RUN IT MANUALLY: visit /admin8828051506/cron/run-audit.php?manual=1 while
   ...
   Jobs" section. Add a job that runs once daily and executes:
     php /home/YOUR_USERNAME/public_html/admin8828051506/cron/run-audit.php --scheduled
...
if (!$isCli) {
    header('Location: /admin8828051506/optimizer.php?report_id=' . $reportId);
    exit;
}
