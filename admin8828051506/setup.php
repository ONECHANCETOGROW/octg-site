...
if ($existingCount > 0) {
    ...
    die('Setup has already been completed — an admin account already exists. Go to <a href="/admin8828051506/login.php">/admin8828051506/login.php</a>. If you\'re locked out, an existing admin needs to reset your account directly in the database.');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        header('Location: /admin8828051506/login.php?created=1');
        exit;
    }
}
?>
