...
<div class="admin-panel">
  <div class="admin-panel__body">
    ...
    <a href="/admin8828051506/cron/run-audit.php?manual=1" class="admin-btn admin-btn-primary">Run Audit Now</a>
  </div>
</div>
<?php else: ?>
...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
  ...
  <a href="/admin8828051506/cron/run-audit.php?manual=1" class="admin-btn admin-btn-small">Run New Audit</a>
</div>
...
<div class="admin-panel">
  <div class="admin-panel__head">
    ...
    <a href="/admin8828051506/optimizer-drafts.php" class="admin-btn admin-btn-small">Review Draft Improvements</a>
  </div>
